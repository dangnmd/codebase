...
config.init_prometheus_data_dir('codebase_api')

BASE_DIR = os.path.dirname(os.path.abspath(__file__))

DEBUG = config.DEBUG
TEST = config.TESTING
SECRET_KEY = 'pxp3+0rz56$y0utqf%b=rw4_@nvbpu*9-e^a6ayp7fkaj-c*yl'
...
MIDDLEWARE = (
	'common.prometheus_utils.ExtendedMetricsMiddleware',
...
WSGI_APPLICATION = 'codebase_api.wsgi.application'
