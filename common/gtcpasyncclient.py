...
class GTcpAsyncClient(object):
	...
	def __init__(self, id, address, port, on_receive_packet, on_connect=None, on_disconnect=None):	# pylint: disable=redefined-builtin
		self._id = id
	...
	def send(self, packet):
		event_loop.add_callback(self._send, packet)
