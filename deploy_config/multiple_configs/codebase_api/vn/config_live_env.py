...
RUNNING_ENVIRONMENT = RunningEnvironment.PRODUCTION
DEBUG = False
TESTING = True
...
SENTRY_DSN = "http://6247f36787784280b9b739808352f2b5@sentry.cooky.com.vn:9000/5"

METRICS_DATA_LOCATION = "/data/prometheus/%s"
METRICS_IP_WHITELIST = (
	'127.0.0.1',
	'210.211.116.165',  # open vpn
	'210.211.116.175',  # tool server
	'103.147.186.90'    # monitor
)
